...
//	$to_Email   	= "ideaspartymx@gmail.com"; //Replace with recipient email address
	...
	$edad        = filter_var($_POST["nombre"], FILTER_SANITIZE_STRING);
	$ciudad        = filter_var($_POST["nombre"], FILTER_SANITIZE_STRING);
	$codigo        = filter_var($_POST["nombre"], FILTER_SANITIZE_STRING);
