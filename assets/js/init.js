...
jQuery(document).ready(function ($) {
    ...
    $("#submit_btn").click(function (event) {
        ...
        var person_name = document.getElementById("nombre").value;
        ...
        if (person_name == "") {
            var error1 = '<div class="enter-name col-lg-3 align-center"> Ingresa tu Nombre </div>';
        ...
        if (user_email == "") {
            var error2 = '<div class="enter-email col-lg-3 align-center"> Ingresa tu Correo Electronico </div>';
        ...
        if (edad == "") {
            var error2 = '<div class="enter-email col-lg-3 align-center"> Ingresa tu Edad </div>';
            jQuery("#result").hide().html(error2).fadeIn(500);
            proceed = false;
        ...
        if (ciudad == "") {
            var error2 = '<div class="enter-email col-lg-3 align-center"> Ingresa tu Ciudad </div>';
            jQuery("#result").hide().html(error2).fadeIn(500);
            proceed = false;
        ...
        if (codigo == "") {
            var error2 = '<div class="enter-email col-lg-3 align-center"> Ingresa el Codigo  </div>';
            jQuery("#result").hide().html(error2).fadeIn(500);
            proceed = false;
        ...
        if (codigo.length < 10) {
            var error2 = '<div class="enter-email col-lg-3 align-center"> Codigo Invalido  </div>';
            jQuery("#result").hide().html(error2).fadeIn(500);
            proceed = false;
            ...
            var invalid = '<div class="invalid-email col-lg-3 align-center"> Correo invalido </div>';
...
var options = {videoId: 'cID7LuywYf0', repeat: true};
